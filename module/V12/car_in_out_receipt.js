...
const insert_receipt = (userData, receipt_no, base_amt, cgst, sgst, igst, paid_amt, gst_flag, trans_flag, paymode) => {
    return new Promise(async (resolve, reject) => {
        try {
            let datetime = dateFormat(new Date(), "yyyy-mm-dd HH:MM:ss");
...
const insert_advance_receipt_update = (userData, receipt_no, base_amt, advance_amt, cgst, sgst, igst, paid_amt, gst_flag, trans_flag) => {
    return new Promise(async (resolve, reject) => {
        try {
            let datetime = dateFormat(new Date(), "yyyy-mm-dd HH:MM:ss");
...
const outpass_advance_receipt_update = (userData, receipt_no, base_amt, cgst, sgst, igst, paid_amt, gst_flag, trans_flag, paymode) => {
    return new Promise(async (resolve, reject) => {
        try {
            let datetime = dateFormat(new Date(), "yyyy-mm-dd HH:MM:ss");
