...
const { dashboard, blank, superadmin_dashboard, project_dashboard } = require('../controller/customer/Dashboard.controller');
...
Customer.get('/superadmin/project_dashboard', AuthSuperCheckedMW, project_dashboard);
