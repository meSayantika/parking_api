...
const { device, show_device, edit_device, save_edit_device, save_add_device, device_id, get_gst_type } = require('../controller/customer/Device.controller');
const { AuthCheckedMW } = require('../middleware/AuthChecked.middleware');
 ...
 DeviceRouter.get('/get_gst_type',AuthCheckedMW,get_gst_type);
